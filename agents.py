...
from tools import blood_report_reader_tool  # ✅ FINAL working tool
from langchain_openai import ChatOpenAI  # ✅ FIXED: missing import

# ✅ Proper LLM instance setup
llm = ChatOpenAI(temperature=0.7, model="gpt-3.5-turbo")

# ✅ Doctor Agent - uses the blood report reader tool
doctor = Agent(
    ...
    tools=[blood_report_reader_tool],  # ✅ CrewAI-compatible tool
    llm=llm,
    max_iter=3,
    max_rpm=10,
...
# ✅ Verifier Agent - does not use tools
verifier = Agent(
...
# ✅ Nutritionist Agent - does not use tools
nutritionist = Agent(
...
# ✅ Exercise Coach Agent - does not use tools
