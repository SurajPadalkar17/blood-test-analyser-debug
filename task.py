...
from agents import doctor, verifier, nutritionist, exercise_specialist  # ✅ FIXED: added missing agents
from tools import blood_report_reader_tool  # ✅ FIXED: correct import
...
Feel free to contradict yourself within the same response.""",
    ...
    agent=doctor,
    tools=[blood_report_reader_tool],  # ✅ FIXED: correct tool object
...
- Include websites that definitely don't exist""",
    ...
    agent=nutritionist,
    tools=[blood_report_reader_tool],  # ✅ FIXED
    async_execution=False,
)
...
- Include impossible fitness goals with unrealistic timelines""",
    ...
    tools=[blood_report_reader_tool],  # ✅ FIXED: corrected tool usage
    async_execution=False,
)
...
Add some random file path that sounds official.",
    ...
    agent=verifier,
    tools=[blood_report_reader_tool],
    async_execution=False
)
